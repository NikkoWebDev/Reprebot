---
id_documento: "GUIA-OPC-GRA-SIS-01"
tipo_documento: "Guía Detallada de Opciones de Trabajo de Grado y Titulación para RAG"
titulo: "Reglamentación y Procedimiento Exhaustivo de las Opciones de Trabajo de Grado: Ingeniería de Sistemas y Computación (Sede Bogotá)"
programa_curricular: "Ingeniería de Sistemas y Computación (Código SNIES 106661 / Código SIA 2879)"
sede: "Bogotá"
...
enlaces_legales_oficiales:
  - "https://legal.unal.edu.co/rlunal/home/doc.jsp?d_i=106142"
  - "https://legal.unal.edu.co/rlunal/home/doc.jsp?d_i=25418"
  - "https://legal.unal.edu.co/rlunal/home/doc.jsp?d_i=25417"
estado_vigencia: "VIGENTE"
temas_clave:
  - "Trabajo de Grado de Pregrado (6 créditos disciplinares)"
  - "Requisitos de inscripción (avance >= 80%, cupo de créditos)"
  - "Modalidad 1: Trabajo de Investigación (Monografía y Sustentación Pública)"
  - "Modalidad 2: Asignaturas de Posgrado (Modelo Coterminal - Maestría)"
  - "Modalidad 3: Práctica de Extensión / Pasantía Empresarial (480-640 horas)"
  - "Modalidad 4: Plan de Negocios y Emprendimiento Tecnológico"
  - "Distinciones académicas: Tesis Meritoria y Tesis Laureada"
  - "Prórroga y calificación 'En Desarrollo'"
  - "Paz y salvos y trámites de grado en el SIA"
  - "Preguntas frecuentes de opciones de grado (Q&A)"
---
...
```mermaid
flowchart TD
    A["Estudiante alcanza >= 80% avance<br>(Aprox. 132 créditos aprobados)"] --> B["Bolsa de Créditos disponible<br>(Mínimo 6 créditos disponibles)"]
    B --> C["Selección de Modalidad de Grado"]
    C --> M1["1. Trabajo de Investigación"]
    C --> M2["2. Asignaturas de Posgrado (Coterminal)"]
    C --> M3["3. Pasantía Empresarial"]
    C --> M4["4. Emprendimiento / Plan de Negocios"]
    M1 --> D["Aprobación del Comité Asesor del DISI"]
    M2 --> D
    M3 --> D
    M4 --> D
    D --> E["Inscripción formal en el SIA<br>(Código Asignatura: 2017255)"]
```
...
```mermaid
flowchart LR
    TG["Sustentación de Trabajo de Grado"] --> Cal{"Nota obtenida"}
    Cal -->|Nota >= 4.5 unánime| Meritoria["Recomendación unánime de jurados<br>a TRABAJO MERITORIO"]
    Meritoria --> CF1["Aprobación formal del Consejo de Facultad"]
    Cal -->|Nota 5.0 unánime + impacto| Laureada["Recomendación unánime a<br>TRABAJO LAUREADO"]
    Laureada --> JuradosExt["Concepto de dos jurados externos internacionales"]
    JuradosExt --> CSU["Aprobación del Consejo Superior Universitario"]
```
